...
class App {
  constructor() {
      ...
      locale: 'en-gb',
        ...
        // defaultView: 'list',
          ...
          eventRender: function (info) {
            ...
            return App.categories.get((info.event.extendedProps.category))
        ...
        events:   async function(fetchInfo,successCallback){
              ...
              let result = await App.getEvents()
                App.printCheckboxes()
                // App.checkCheckboxes()
    ...
    // this.$nextButton = document.querySelector(".fc-next-button")
    }
      ...
      await fetch(this.local)
            ...
            xmlDOM.querySelectorAll("show").forEach(show => { 
              ...
              if(!App.categories.has(category)){
                App.categories.set(category, true)
              }
  ...
  addEventListeners(){
    ...
    // App.$nextButton.addEventListener("click", function() {console.log('next!')})
